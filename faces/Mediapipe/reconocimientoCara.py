...
if faces:
    ...
    print("No se encontraron datos de rostros o nombres en la carpeta 'data'.")
    exit()
...
prev_bbox = None
iou_threshold = 0.5
confidence_threshold = 60.0  # 50% confidence threshold
...
while True:
    ...
    if ret:
        ...
        if selected_bbox is not None:
            ...
            # Display name only if confidence is 50% or higher
